...
('root', '[{\"db\":\"\\u0411\\u0430\\u0437\\u0430\",\"table\":\"status\"},{\"db\":\"\\u0411\\u0430\\u0437\\u0430\",\"table\":\"request\"},{\"db\":\"\\u0411\\u0430\\u0437\\u0430\",\"table\":\"role\"},{\"db\":\"\\u0411\\u0430\\u0437\\u0430\",\"table\":\"user\"}]');
...
('root', '2024-09-05 11:29:39', '{\"lang\":\"ru\",\"Console\\/Mode\":\"collapse\"}');
...
-- База данных: `База`
--
CREATE DATABASE IF NOT EXISTS `База` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `База`;
